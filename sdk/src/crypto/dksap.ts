 ...
 * is the client-side gate: see contracts/payments.ts's StealthRegistry.registerKeys
 * and contracts/stealth-registry/src/lib.rs's is_valid_secp256k1_pubkey doc
